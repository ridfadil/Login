...
import com.example.recyclerviewpertemuan.model.RegisterResponse;
import com.example.recyclerviewpertemuan.utils.DialogUtils;

import static com.example.recyclerviewpertemuan.data.Constans.LOGIN;
import static com.example.recyclerviewpertemuan.data.Constans.REGISTER;
        ...
        AndroidNetworking.post(REGISTER)
                ...
                .getAsObject(RegisterResponse.class, new ParsedRequestListener() {
                    ...
                    public void onResponse(Object response) {
                        if (response instanceof RegisterResponse) {
                            ...
                            if (res.getStatus().equals("success")) {
                                Toast.makeText(RegisterActivity.this, "Register Berhasil, silakan login kembali", Toast.LENGTH_SHORT).show();
                                finish();
                            } else {
                    ...
                    public void onError(ANError anError) {
                        Toast.makeText(RegisterActivity.this, "Terjadi kesalahan API", Toast.LENGTH_SHORT).show();
                        DialogUtils.closeDialog();
                    }
                });
    }
